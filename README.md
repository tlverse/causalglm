...
Throughout the development of `causalglm`, we greatly focused on making this package and all its methods as easy to use as possible. Our goal is that this package can be used by a wide audience including amateurs, practioners, statisticians, causal-inference experts and nonexperts.
