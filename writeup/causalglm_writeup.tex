...
\subsection{Semiparametric and nonparametric generalized linear models for conditional causal inference using Targeted Maximum Likelihood Estimation in low and high dimensions}
...
1: CATE (Intercept) 0.974924 0.03756467 0.9012986 1.048549 410.3563       0
\end{Soutput}
\end{Schunk}
...
\begin{Soutput}
   type       param  tmle_est         se     lower    upper  Z_score p_value
1: CATE (Intercept) 0.9254711 0.05101393 0.8254856 1.025457 286.8429       0
2: CATE           W 1.1226342 0.09122935 0.9438279 1.301440 194.5690       0
\end{Soutput}
\end{Schunk}
...
\begin{Soutput}
   type       param  tmle_est         se     lower    upper  Z_score p_value
1: CATE (Intercept) 0.9665992 0.05387751 0.8610012 1.072197 283.6671       0
2: CATE           W 1.0879020 0.09544206 0.9008390 1.274965 180.2271       0
\end{Soutput}
\begin{Sinput}
...
\begin{Soutput}
   type       param  tmle_est         se     lower    upper  Z_score p_value
1: CATE (Intercept) 0.9612229 0.05424115 0.8549122 1.067534 280.1981       0
2: CATE           W 1.0819919 0.09593940 0.8939541 1.270030 178.3187       0
\end{Soutput}
\begin{Sinput}
...
\begin{Soutput}
   type       param  tmle_est         se     lower    upper  Z_score p_value
1: CATE (Intercept) 0.9619887 0.05857263 0.8471885 1.076789 259.6840       0
2: CATE           W 1.0837580 0.09638020 0.8948562 1.272660 177.7929       0
\end{Soutput}
\end{Schunk}
...
\begin{Soutput}
   type       param  tmle_est         se     lower    upper  Z_score p_value
1: CATE (Intercept) 0.9733916 0.05385283 0.8678420 1.078941 285.7913       0
2: CATE           W 1.0598753 0.08929428 0.8848617 1.234889 187.6727       0
\end{Soutput}
\end{Schunk}
...
\begin{Soutput}
   type       param  tmle_est         se     lower    upper  Z_score p_value
1: CATE (Intercept) 0.9673789 0.05382626 0.8618814 1.072876 284.1662       0
2: CATE           W 1.0903127 0.09248130 0.9090527 1.271573 186.4091       0
\end{Soutput}
\end{Schunk}
...
1:   OR (Intercept) 1.2918581 0.3154199  0.67364651 1.910070 3.639543 1.9613765
2:   OR           W 0.9794396 0.5350977 -0.06933258 2.028212 2.662963 0.9330163
   upper_exp  Z_score p_value
1:  6.753560 64.75835       0
2:  7.600483 28.94107       0
\end{Soutput}
\begin{Sinput}
> # RR
...
\begin{Soutput}
   type       param  tmle_est        se     lower    upper  psi_exp lower_exp
1:   RR (Intercept) 0.7984247 0.1152801 0.5724798 1.024370 2.222038  1.772657
2:   RR           W 1.1595596 0.2135176 0.7410728 1.578046 3.188529  2.098185
   upper_exp   Z_score p_value
1:  2.785339 109.50892       0
2:  4.845481  85.86761       0
\end{Soutput}
\begin{Sinput}
> 
\end{Sinput}
...
1: CATE (Intercept) 1.052173 1.024999 0.1091037 0.8111598 1.238838
2: CATE           W 1.030469 1.035008 0.1735572 0.6948425 1.375174
   psi_transformed lower_transformed upper_transformed
1:        1.024999         0.8111598          1.238838
2:        1.035008         0.6948425          1.375174
\end{Soutput}
\begin{Sinput}
> # CATT
> Y <- rnorm(n, mean = A + A * W + W + sin(5 * W), sd = 0.5)
...
\begin{Soutput}
   type       param  init_est  tmle_est        se     lower    upper
1: CATT (Intercept) 0.9262390 0.9258107 0.0640027 0.8003677 1.051254
2: CATT           W 0.9267867 0.9430870 0.1254964 0.6971186 1.189055
   psi_transformed lower_transformed upper_transformed
1:       0.9258107         0.8003677          1.051254
2:       0.9430870         0.6971186          1.189055
\end{Soutput}
\begin{Sinput}
> # TSM
> Y <- rnorm(n, mean = A + A * W + W + sin(5 * W), sd = 0.5)
...
\begin{Soutput}
   type       param  init_est tmle_est         se     lower    upper
1: CATT (Intercept) 0.9912969 0.995758 0.07147714 0.8556654 1.135851
2: CATT           W 1.1082472 1.099562 0.11695959 0.8703253 1.328798
   psi_transformed lower_transformed upper_transformed
1:        0.995758         0.8556654          1.135851
2:        1.099562         0.8703253          1.328798
\end{Soutput}
\begin{Sinput}
> # OR
> Y <- rbinom(n, size =  1, prob = plogis(A + A * W + W + sin(5 * W)))
...
\begin{Soutput}
   type       param init_est  tmle_est        se      lower    upper
1:   OR (Intercept) 0.991811 0.9831661 0.3414462  0.3139438 1.652388
2:   OR           W 1.422093 1.2662779 0.7176239 -0.1402391 2.672795
   psi_transformed lower_transformed upper_transformed
1:        2.672906         1.3688129          5.219431
2:        3.547623         0.8691504         14.480385
\end{Soutput}
\begin{Sinput}
> # RR
> Y <- rpois(n, lambda = exp(A + A * W + sin(5 * W)))
...
\begin{Soutput}
   type       param init_est tmle_est        se     lower    upper
1:   RR (Intercept) 1.228618 1.239101 0.1095864 1.0243160 1.453887
2:   RR           W 1.027852 1.027396 0.2054616 0.6246982 1.430093
   psi_transformed lower_transformed upper_transformed
1:         3.45251          2.785190          4.279717
2:         2.79378          1.867682          4.179088
\end{Soutput}
\begin{Sinput}
> 
\end{Sinput}
