...
\title{%
  \pkg{causalglm}: A \pkg{tlverse} \proglang{R} package for interpretable and robust causal inference for heterogeneous treatment effects using generalized linear models and targeted machine-learning. 
  }
\Plaintitle{causalglm: Interpretable and robust causal inference for heterogeneous treatment effects using generalized linear models and targeted machine-learning}
...
\Shorttitle{\pkg{causalglm}: interpretable and robust causal inference for heterogeneous treatment effects}
