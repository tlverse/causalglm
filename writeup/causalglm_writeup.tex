...
1: CATE (Intercept) 1.002988 0.04012527 0.9243441 1.081632 395.2281       0
\end{Soutput}
\begin{Sinput}
> 
\end{Sinput}
...
\begin{Soutput}
A causalglm fit object obtained from spglm for the estimand CATE with formula 
CATE(W) = 1.09 * (Intercept) + 1.05 * W
[1] "Coefficient estimates and inference:"

   type       param tmle_est         se     lower    upper  Z_score p_value
1: CATE (Intercept) 1.086353 0.05347580 0.9815420 1.191163 321.2059       0
2: CATE           W 1.052821 0.09144093 0.8736001 1.232042 182.0472       0
\end{Soutput}
\begin{Sinput}
> 
\end{Sinput}
...
1           1  0.9293763 2.0648196 1.3967894 1.8916718 2.2379674 23.37336
2           1  0.3674931 1.4732571 0.8786695 1.3643361 1.5821781 26.51081
3           1 -0.3301924 0.7387191 1.0701067 0.6060673 0.8713709 10.91496
4           1  0.9954337 2.1343663 1.4752399 1.9514936 2.3172389 22.87580
5           1  0.8139898 1.9433383 1.2653926 1.7864786 2.1001980 24.28248
6           1  0.5843620 1.7015813 1.0347436 1.5733131 1.8298494 26.00100
  p-value
1       0
2       0
3       0
...
\begin{Soutput}
A causalglm fit object obtained from spglm for the estimand CATE with formula 
CATE(W) = 1.02 * (Intercept) + 1.03 * W
[1] "Coefficient estimates and inference:"

   type       param tmle_est         se     lower    upper  Z_score p_value
1: CATE (Intercept) 1.018789 0.05095567 0.9189180 1.118661 316.1272       0
2: CATE           W 1.034057 0.07800932 0.8811612 1.186952 209.5887       0
\end{Soutput}
\begin{Sinput}
...
\begin{Soutput}
A causalglm fit object obtained from spglm for the estimand CATE with formula 
CATE(W) = 1 * (Intercept) + 1.03 * W
[1] "Coefficient estimates and inference:"

   type       param tmle_est         se     lower    upper  Z_score p_value
1: CATE (Intercept) 1.003556 0.05121096 0.9031848 1.103928 309.8482       0
2: CATE           W 1.030164 0.08798331 0.8577202 1.202608 185.1298       0
\end{Soutput}
\begin{Sinput}
...
\begin{Soutput}
A causalglm fit object obtained from spglm for the estimand CATE with formula 
CATE(W) = 1.02 * (Intercept) + 1.04 * W
[1] "Coefficient estimates and inference:"

   type       param tmle_est         se     lower   upper  Z_score p_value
1: CATE (Intercept) 1.021216 0.05497772 0.9134613 1.12897 293.6978       0
2: CATE           W 1.043797 0.08506422 0.8770740 1.21052 194.0167       0
\end{Soutput}
\end{Schunk}
...
[1] "Coefficient estimates and inference:"
   ...
   type       param tmle_est         se     lower    upper  Z_score p_value
1: CATE (Intercept) 1.014782 0.05048656 0.9158298 1.113733 317.8094       0
2: CATE           W 1.032108 0.07867727 0.8779032 1.186312 207.4177       0
\end{Soutput}
\end{Schunk}
...
[1] "Coefficient estimates and inference:"
   ...
   type       param tmle_est         se     lower    upper  Z_score p_value
1: CATE (Intercept) 1.016422 0.05127196 0.9159305 1.116913 313.4469       0
2: CATE           W 1.029178 0.08306707 0.8663696 1.191987 195.8987       0
\end{Soutput}
\end{Schunk}
...
log OR(W) = 0.649 * (Intercept) + 0.408 * W
[1] "Coefficient estimates and inference:"

   type       param  tmle_est        se       lower    upper  psi_exp lower_exp
1:   OR (Intercept) 0.6485099 0.2924393  0.07533944 1.221680 1.912689 1.0782501
2:   OR           W 0.4084865 0.5034409 -0.57823956 1.395213 1.504539 0.5608849
   upper_exp  Z_score p_value
1:  3.392884 35.06315       0
2:  4.035833 12.82919       0
\end{Soutput}
\begin{Sinput}
> # RR
...
log RR(W) = 0.935 * (Intercept) + 0.887 * W
[1] "Coefficient estimates and inference:"

   type       param  tmle_est         se     lower    upper  psi_exp lower_exp
1:   RR (Intercept) 0.9350559 0.09287231 0.7530295 1.117082 2.547356  2.123423
2:   RR           W 0.8865872 0.19100238 0.5122294 1.260945 2.426833  1.669008
   upper_exp   Z_score p_value
1:  3.055925 159.19203       0
2:  3.528755  73.39267       0
\end{Soutput}
\end{Schunk}
...
CATE(W) = 0.949 * (Intercept) + 1.12 * W
[1] "Coefficient estimates and inference:"

   type       param  tmle_est        se     lower    upper  Z_score p_value
1: CATE (Intercept) 0.9493787 0.1074288 0.7388220 1.159935 139.7297       0
2: CATE           W 1.1205540 0.1635730 0.7999569 1.441151 108.3157       0
\end{Soutput}
\begin{Sinput}
> # CATT
> Y <- rnorm(n, mean = A + A * W + W + sin(5 * W), sd = 0.5)
...
CATT(W) = 0.98 * (Intercept) + 0.955 * W
[1] "Coefficient estimates and inference:"

   type       param  tmle_est         se     lower    upper  Z_score p_value
1: CATT (Intercept) 0.9801899 0.06386701 0.8550128 1.105367 242.6630       0
2: CATT           W 0.9545239 0.11352895 0.7320112 1.177037 132.9383       0
\end{Soutput}
\begin{Sinput}
> # TSM
> Y <- rnorm(n, mean = A + A * W + W + sin(5 * W), sd = 0.5)
...
TSM(W) = -0.00581 * E[Y_{A=0}]: (Intercept) + 0.658 * E[Y_{A=0}]: W + 1.02 * E[Y_{A=1}]: (Intercept) + 1.5 * E[Y_{A=1}]: W
[1] "Coefficient estimates and inference:"

   type                   param     tmle_est         se      lower     upper
1:  TSM E[Y_{A=0}]: (Intercept) -0.005812043 0.05911024 -0.1216660 0.1100419
2:  TSM           E[Y_{A=0}]: W  0.658255840 0.09035432  0.4811646 0.8353471
3:  TSM E[Y_{A=1}]: (Intercept)  1.017105856 0.06299438  0.8936391 1.1405726
4:  TSM           E[Y_{A=1}]: W  1.504012387 0.10141045  1.3052516 1.7027732
      Z_score p_value
1:   1.554662 0.12003
2: 115.190267 0.00000
3: 255.290334 0.00000
4: 234.497773 0.00000
\end{Soutput}
\begin{Sinput}
> # OR
> Y <- rbinom(n, size = 1, prob = plogis(A + A * W + W + sin(5 * W)))
...
log OR(W) = 1.38 * (Intercept) + 0.979 * W
[1] "Coefficient estimates and inference:"

   type       param tmle_est        se      lower    upper  psi_exp lower_exp
1:   OR (Intercept) 1.383272 0.3227203  0.7507523 2.015793 3.987931 2.1185932
2:   OR           W 0.979298 0.5851159 -0.1675080 2.126104 2.662587 0.8457699
   upper_exp  Z_score p_value
1:  7.506675 67.77218       0
2:  8.382147 26.46324       0
\end{Soutput}
\begin{Sinput}
> # RR
> Y <- rpois(n, lambda = exp(A + A * W + sin(5 * W)))
...
log RR(W) = 0.973 * (Intercept) + 0.84 * W
[1] "Coefficient estimates and inference:"

   type       param  tmle_est        se     lower    upper  psi_exp lower_exp
1:   RR (Intercept) 0.9734054 0.1022388 0.7730210 1.173790 2.646943  2.166301
2:   RR           W 0.8404128 0.1934324 0.4612923 1.219533 2.317323  1.586122
   upper_exp   Z_score p_value
1:  3.234227 150.53863       0
2:  3.385607  68.69632       0
\end{Soutput}
\begin{Sinput}
> head(predict(output, data = data))
\end{Sinput}
...
1           1  0.786821024 5.127713 3.024702 3.524413 7.460375  8.545055
2           1 -0.493378637 1.748509 2.103146 1.347236 2.269302  4.200768
3           1 -0.004767591 2.636359 1.615207 2.157986 3.220774  9.489519
4           1  0.885070217 5.569079 3.283034 3.707139 8.366192  8.270332
5           1  0.225320169 3.198773 1.816959 2.553678 4.006828 10.118538
6           1 -0.443425674 1.823476 2.008176 1.421637 2.338900  4.729970
     p-value
1 0.0000e+00
2 2.6601e-05
3 0.0000e+00
