...
\Plaintitle{causalglm: Semiparametric and nonparametric generalized linear models and interpretable causal inference for heterogeneous treatment effects using targeted machine-learning with the tlverse ecosystem}
...
\Shorttitle{\pkg{causalglm}: Robust adaptive generalized linear models and interpretable causal inference for treatment effects}
